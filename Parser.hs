...
--These are the primitive functions , that would be used to build more shopiscated function.
...
-- stdout is a handle that manges standard output . 
flushStr :: String -> IO ()
flushStr str = putStr str >> hFlush stdout

readPrompt :: String -> IO String
readPrompt prompt = flushStr prompt >> readLn
